...
class GazeboOdometryPlugin : public ModelPlugin {
 public:
  ...
  GazeboOdometryPlugin()
      : ModelPlugin(),
        pose_pub_topic_(default_topics::POSE),
        pose_with_covariance_pub_topic_(default_topics::POSE_WITH_COVARIANCE),
        position_pub_topic_(default_topics::POSITION),
        transform_pub_topic_(default_topics::TRANSFORM),
        odometry_pub_topic_(default_topics::ODOMETRY),
