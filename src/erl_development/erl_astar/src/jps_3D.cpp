...
double erl::JPS_3D::plan( int xStart, int yStart, int zStart,
...
void erl::JPS_3D::spin(Astate *currNode_pt)
{
  ...
  int nx, ny, nz, dxNeighbor, dyNeighbor, dzNeighbor;
...
void erl::JPS_3D::jump(int x, int y, int z, int dx, int dy, int dz)
{
...
constexpr int erl::JPS_NEIB::nsz_[4][3];
erl::JPS_NEIB::JPS_NEIB()
{
...
void erl::JPS_NEIB::Neib(int dx, int dy, int dz, int norm1, int dev,
...
void erl::JPS_NEIB::FNeib( int dx, int dy, int dz, int norm1, int dev,
...
/*
bool erl::JPS_3D::hasForced(int x, int y, int z, int dx, int dy, int dz, int norm1)
{
  dx+=1;dy+=1;dz+=1;
  switch(norm1)
  {
...
/*
void erl::JPS_3D::prune(int dx, int dy, int dz,
...
*/
/*
void erl::JPS_NEIB::Neib(int dx, int dy, int dz, int nx, int ny, int nz,
                      int& tx, int& ty, int& tz)
{
  if(dx == 0 && dy == 0 && dz == 1){
    tx = -nz; ty = ny; tz = nx;
...
/*
void erl::JPS_NEIB::Neib2(int dx, int dy, int dz, int nx, int ny, int nz,
